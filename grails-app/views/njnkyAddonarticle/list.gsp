    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-header">内江农科院文章搜索栏</div>
                        ...
                        <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    ...
                                    <div class="layui-input-inline">
                                        <input name="body" id="body" class="layui-input" placeholder="请输入内容" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="layui-inline">
...
<script>
    ...
    function showAddOrUpdateModel(data,showType) {
        ...
        // 打开子页面
        layer.open({
            title: titleSet + '内江农科院文章', //设置标题
            type: 2, // 格式为打开网页的iframe的子页面
            area: ['99%','99%'], //
            content: '${r}/njnkyAddonarticle/edit', // 接口地址
            fixed: false, // 不固定
            maxmin: true,
            closeBtn:1,
            shadeClose: true,
